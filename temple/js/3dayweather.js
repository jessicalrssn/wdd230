const apiURL3= "https://api.openweathermap.org/data/2.5/forecast?lat=41&lon=12&units=imperial&appid=76fda5fbdea32e8ea0ce839e840b62d5"

fetch(apiURL)
  .then((response) => response.json())
  .then((jsObject) => {
      console.log(jsObject);
     document.querySelector('#t3').textContent = jsObject.main.temp.toFixed(0);
